...
class AcademicianStudentsPageMobile extends StatefulWidget {
  const AcademicianStudentsPageMobile({super.key});

  @override
  State<AcademicianStudentsPageMobile> createState() =>
      _AcademicianStudentsPageState();
}

class _AcademicianStudentsPageState extends State<AcademicianStudentsPageMobile> {
