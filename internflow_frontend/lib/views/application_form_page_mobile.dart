...
class ApplicationFormPageMobile extends StatefulWidget {
  const ApplicationFormPageMobile({super.key});

  @override
  State<ApplicationFormPageMobile> createState() => _ApplicationFormPageState();
}

class _ApplicationFormPageState extends State<ApplicationFormPageMobile> {
