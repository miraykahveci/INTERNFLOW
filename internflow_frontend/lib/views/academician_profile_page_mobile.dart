...
class AcademicianProfileMobile extends StatefulWidget {
  const AcademicianProfileMobile({super.key});
 
  @override
  State<AcademicianProfileMobile> createState() => _AcademicianProfileMobileState();
}
 
class _AcademicianProfileMobileState extends State<AcademicianProfileMobile> {
