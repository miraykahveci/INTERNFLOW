...
class StudentProcessPageMobile extends StatefulWidget {
  const StudentProcessPageMobile({super.key});

  @override
  State<StudentProcessPageMobile> createState() => _StudentProcessPageMobileState();
}

class _StudentProcessPageMobileState extends State<StudentProcessPageMobile> {
